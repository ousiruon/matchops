...
import { Position, Player } from "@/data/types/interfaces";
import { editPlayer } from "@/store/playersSlice";
...
const EditPlayerPage = () => {
  ...
  const [singlePlayer, setSinglePlayer] = useState<Player | null>(null);
  ...
  const formSubmited = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      ...
      const newPlayer: Player = {
        ...
        image: singlePlayer?.image || "/players/noImage.png",
  ...
  useEffect(() => {
    const player = retrievedPlayers.find((player) => player.id === playerID);
    if (player) {
      setSinglePlayer(player);
    } else {
      navigate.push("/players");
    }
  }, [retrievedPlayers, playerID, navigate]);
  useEffect(() => {
    if (isSuccess) {
  ...
  if (isLoggedIn && singlePlayer) {
    return (
      <>
        <div className="p-4">
          <div className="w-full flex flex-col gap-10">
            <div className="font-bold text-base md:text-xl">Edit Player</div>
            {isSubmitted && (
            ...
            >
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-full">
                  ...
                  <input
                    defaultValue={singlePlayer.name}
                    type="text"
                    name="playerName"
                    id="playerName"
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-full">
                  ...
                  <select
                    defaultValue={singlePlayer.nationality}
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-full">
                  ...
                  <select
                    defaultValue={singlePlayer.position}
                    name="playerPosition"
                    id="playerPosition"
                    className="w-full flex-1 bg-bg-light dark:bg-bg-dark text-text-light dark:text-text-dark border border-text-light dark:border-text-dark rounded px-4 py-1 outline-0 transition-all ease-in duration-300 max-w-[300px]"
                  >
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-full">
                  ...
                  <input
                    ...
                    max={200}
                    defaultValue={
                      singlePlayer.height ? singlePlayer.height : 180
                    }
                    name="playerHeight"
                    id="playerHeight"
                    placeholder="cm"
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-full">
                  ...
                  <input
                    defaultValue={
                      singlePlayer.dob
                        ? new Date(singlePlayer.dob).toISOString().split("T")[0]
                        : ""
                    }
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-full">
                  ...
                  <select
                    defaultValue={singlePlayer.preferredFoot}
                    name="playerFoot"
                    id="playerFoot"
                    className="w-full flex-1 bg-bg-light dark:bg-bg-dark text-text-light dark:text-text-dark border border-text-light dark:border-text-dark rounded px-4 py-1 outline-0 transition-all ease-in duration-300 max-w-[300px]"
                  >
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-full">
                  ...
                  <input
                    ...
                    max={99}
                    defaultValue={
                      singlePlayer.shirtNumber ? singlePlayer.shirtNumber : 10
                    }
                    name="playerNumber"
                    id="playerNumber"
                    placeholder="cm"
              ...
              <div className="flex flex-col gap-2 items-start justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-start w-full">
                  ...
                  <input
                    ...
                    min={0}
                    defaultValue={
                      singlePlayer.marketValue ? singlePlayer.marketValue : 0
                    }
                    name="playerValue"
                    id="playerValue"
